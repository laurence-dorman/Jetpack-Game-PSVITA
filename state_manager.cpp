...
StateManager::StateManager(gef::Platform* platform, gef::SpriteRenderer* sprite_renderer, gef::Renderer3D* renderer_3d, gef::Font* font, Camera* camera, gef::AudioManager* audio_manager) :
    current_state_(NULL),
    states_({&mainmenu_state_, &ingame_state_, &pausemenu_state_ , &howto_state_, &mainsettings_state_}),
    ...
    mainsettings_state_(sprite_renderer, audio_manager, font, platform, this),
    platform_(platform),
